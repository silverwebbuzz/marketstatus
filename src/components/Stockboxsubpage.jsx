...
function Stockboxsubpage() {
  ...
  const textColor = { color: isMarketUp ? 'rgb(16, 145, 33)' : 'rgb(192, 9, 9)' };
        ...
        <div className='graph_ahead'>
          <ul>
            <li className='d-value fc'>
              <span>
                <span className='value'>{formatNumber(marketSentiment.indiceSnapData.ltp)}</span>
                <span className={arrowClass}></span>
              </span>
              <span className='change_perc' style={textColor}>
                {formatNumber(marketSentiment.indiceSnapData.price_change)} ({formatNumber(marketSentiment.indiceSnapData.price_change_per)}%)
              </span>
            </li>
            <li className='open fc'>
              <span className='Open'>Open</span>
              <span className='d_open'>{formatNumber(marketSentiment.indiceSnapData.today_open)}</span>
            </li>
            <li className='high fc'>
              <span className='High'>High</span>
              <span className='d_high'>{formatNumber(marketSentiment.indiceSnapData.day_high)}</span>
            </li>
            <li className='low fc'>
              <span className='Low'>Low</span>
              <span className='d_low'>{formatNumber(marketSentiment.indiceSnapData.day_low)}</span>
            </li>
          </ul>
        </div>
      </div>
