        ...
        <div className="container header_row">
          <div className="headerleft_cover">
            <div className="header-left">
              ...
              <a href="https://marketstatus.in/">marketstatus</a>
            </div>
            <div className="create">
              ...
              >
               <rect
                  ...
                  width="509.629"
                  height="201.284"
                  transform="rotate(44.8274 721.699 139.012)"
                  fill="#EF1B28"
                /><path
                d="M724.119 140.88L143.524 731.284L71.3493 660.316C31.9514 621.577 31.4372 558.228 70.2011 518.855L581.024 -0.00012678L724.119 140.88Z"
                fill="#EF1B28"
              />
              <path
                d="M281.029 584.161L535.38 836.985L393.479 979.743L139.128 726.92L281.029 584.161Z"
                fill="#EF1B28"
              />
              <rect
                x="419.287"
