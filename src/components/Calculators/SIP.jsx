    ...
    datasets: [
      {
        ...
        hoverBackgroundColor: ["#c0c0c0", "#388e3c"],
      },
    ],
  };
          ...
          <div className="calculator_container_box">
            <div className="sip_calculator_top">
              ...
              <div className="results">
                <Typography>Investment Amount:<br /> ₹{investedAmount}</Typography>
                <Typography>Estimated Returns:<br /> ₹{totalReturn}</Typography>
                <Typography>Maturity Value:<br /> ₹{futureValue}</Typography>
              </div>
            </div>
